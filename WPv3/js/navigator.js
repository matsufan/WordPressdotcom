(function () {
    ...
    WinJS.Namespace.define("WordPressdotcom", {
        PageControlNavigator: WinJS.Class.define(
            ...
            function (element, options) {
                ...
                _keypressHandler: function (eventObject) {
                    if (eventObject.keyCode === utils.Key.backspace)
                        nav.back();
                },
                ...
                _keyupHandler: function (eventObject) {
                    switch (eventObject.keyCode) {
                        case utils.Key.browserBack:
                        case eventObject.altKey && utils.Key.leftArrow:
                            nav.back();
                            break;
                        case utils.Key.browserForward:
                        case eventObject.altKey && utils.Key.rightArrow:
                            nav.forward();
                            break;
                    }
                },
                ...
                navigated: function () {
                    ...
                    if (this.pageElement.querySelector('.fragment.post')) {
                        WPCom.toggleElement(document.getElementById('viewblog'), 'show');
					    ...
					    WPCom.toggleElement(document.getElementById('viewblog'), 'hide');
        ...
        // This function navigates to the home page and is called whenever a
        // user invokes the AppBar's home button.
